...
Note.create!(author: wen, language: spanish, title: spanish_text[0001..0010], body: spanish_text[0011..0500])
# Note.create!(author: wen, language: spanish, title: spanish_text[0501..0010], body: spanish_text[0511..1000])
# Note.create!(author: wen, language: arabic, title: arabic_text[1001..1010], body: arabic_text[1011..1500])

Note.create!(author: paz, language: english, title: english_text[0001..0010], body: english_text[0011..0500])
# Note.create!(author: paz, language: english, title: english_text[0501..0010], body: english_text[0511..1000])

Note.create!(author: kim, language: arabic, title: arabic_text[0001..0010], body: arabic_text[0011..0500])
# Note.create!(author: kim, language: arabic, title: arabic_text[0501..0010], body: arabic_text[0511..1000])
# Note.create!(author: kim, language: mandarin, title: mandarin_text[1001..1010], body: mandarin_text[1011..1500])

Note.create!(author: yas, language: mandarin, title: mandarin_text[0001..0010], body: mandarin_text[0011..0500])
# Note.create!(author: yas, language: mandarin, title: mandarin_text[0501..0010], body: mandarin_text[0511..1000])
# Note.create!(author: yas, language: hindi, title: mandarin_text[0001..0010], body: mandarin_text[0011..0500])
# Note.create!(author: yas, language: english, title: mandarin_text[0501..0010], body: mandarin_text[0511..1000])
