...
Note.create!(author: kim, language: mandarin, title: "Birthday", body: "Today was a birthday of someone, I just know it! I went to the barbaque park range and played chess with Micky Rourke.")
